<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand d-flex align-items-center m-0"
            ...
            <span class="font-weight-bold text-lg">KOKITA</span>
        </a>
    </div>
    <div class="collapse navbar-collapse px-4  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                    ...
                    <span class="nav-link-text small">Manajemen User</span>
                </a>
            </li>

            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 {{ request()->routeIs('tabel-anggota') ? 'active' : '' }}" href="{{ route('tabel-anggota') }}">
                    <span class="nav-link-text ms-1">Daftar Anggota</span>
                </a>
            </li>
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 {{ request()->routeIs('tabel-kolektor') ? 'active' : '' }}" href="{{ route('tabel-kolektor') }}">
                    <span class="nav-link-text ms-1">Daftar Kolektor</span>
                </a>
            </li>
            {{-- <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 {{ request()->routeIs('kolektor-anggota') ? 'active' : '' }}" href="{{ route('kolektor-anggota') }}">
                    <span class="nav-link-text ms-1">Kolektor Anggota</span>
                </a>
            </li> --}}
            ...
            <li class="nav-item">
                {{-- <a class="nav-link  {{ is_current_route('tables') ? 'active' : '' }}" href="{{ route('tables') }}"> --}}
                    ...
                    <span class="nav-link-text small">Pengelolaan Keuangan</span>
                </a>
            </li>
            ...
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2">
                    <span class="nav-link-text ms-1">Data Pinjaman</span>
                </a>
            <li class="nav-item border-start my-0 pt-2">
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2">
                    <span class="nav-link-text ms-1">Data Simpanan</span>
                </a>
            <li class="nav-item border-start my-0 pt-2">
        </ul>
    </div>
